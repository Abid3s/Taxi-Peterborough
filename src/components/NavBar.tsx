    ...
    <div className="sticky top-0 z-50 backdrop-blur supports-[backdrop-filter]:bg-white/60 bg-white/70 border-b border-white/40">
      <div className="container flex h-16 items-center justify-between">
        <Link href="/" className="flex items-center gap-2">
          <div className="h-8 w-8 rounded-lg bg-accent/90" style={{ backgroundColor: '#00BFA5' }}></div>
          <span className="font-semibold tracking-tight text-slate-900">Taxi Peterborough</span>
        </Link>
        ...
        <Link
          href="#quote"
          className="inline-flex items-center rounded-full bg-slate-900 px-5 py-2.5 text-white text-sm font-medium shadow-[0_10px_30px_rgba(2,6,23,0.25)] hover:translate-y-[-1px] transition"
        >
