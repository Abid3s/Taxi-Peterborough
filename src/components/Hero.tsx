      ...
      <div className="container relative grid gap-10 py-20 lg:grid-cols-2 lg:py-28">
        ...
        <div className="text-white">
          ...
          <div className="mt-8 flex flex-wrap items-center gap-4">
            <a href="#quote" className="rounded-full bg-white text-slate-900 px-6 py-3 text-sm font-semibold shadow-[0_10px_30px_rgba(2,6,23,0.25)] hover:translate-y-[-1px] transition">
        ...
        <div className="relative">
          <div className="rounded-2xl bg-white/10 p-2 backdrop-blur shadow-[0_10px_30px_rgba(2,6,23,0.25)]">
            <img
          ...
          <div className="absolute -bottom-6 -left-6 hidden md:block rounded-2xl bg-white p-4 shadow-[0_10px_30px_rgba(2,6,23,0.25)]">
